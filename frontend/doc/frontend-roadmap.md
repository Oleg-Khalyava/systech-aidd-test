...
| SP-FE-3 | Реализация dashboard | 📋 Запланирован | - | - |
...
### Состав работ
- Реализация layout структуры dashboard (sidebar, header, main content)
- Реализация 4 блоков ключевых метрик (KPI cards):
  - Total Revenue / Общее количество диалогов
  - Visitors / Активные пользователи
  - Active Accounts / Активные сессии
  - Growth Rate / Динамика роста
- Реализация timeline/графиков для визуализации трендов
